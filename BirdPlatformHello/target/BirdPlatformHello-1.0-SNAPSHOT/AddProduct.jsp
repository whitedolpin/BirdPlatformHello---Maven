...
<html lang="en">
  ...
  <body>
     ...
     <section class="userInfo">
      ...
      <div class="user__details">
        <div class="input__box">
         ...
         <textarea style="width: 500px; height: 300px;" name="description" type="text" placeholder="" required>
     ...
     <section class="userInfo">
      ...
      <div class="user__details">
        ...
        <div class="input__box">
          ...
          <input name="sale" type="text" placeholder="" pattern="[0-9]{1,2}(\.[0-9]{1,2})?%?" title="Enter a value between 0% and 90%" required>
	...
	<div class="confirm-box">
		...
		<div class="line"></div>
                <a class="check-out__delete" href="Shopdashboard.jsp">Cancel</a>
